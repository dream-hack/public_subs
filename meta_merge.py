...
def process_clash(data, index):
    ...
    for i, proxy in enumerate(proxies):
        ...
        proxy["name"] = f"{location}_{index}{i+1}"
...
#           "GeoLite2-City.mmdb"
            "https://github.com/P3TERX/GeoLite.mmdb/releases/download/2024.09.19/GeoLite2-City.mmdb"
        )  # 这里的路径需要指向你自己的数据库文件
